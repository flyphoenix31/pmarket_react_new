...
import { updateQuotation, setRedirect, findOneQuotation } from '../store/slice/quotationSlice.js';
import { TitleSVG } from '../components/SVG.js';
...
const QuotationEdit = () => {
  ...
  useEffect(() => {
    if (!isEmpty(currentQuotation)) {
      ...
      setQuotationList(currentQuotation.items);
    }
  }, [currentQuotation])
