        ...
        <>
            ...
            >
                <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark" >
                    <div className="flex flex-wrap items-center" style={{ minHeight: 'calc(100vh - 2px)' }}>
                        <div className="hidden w-full xl:block xl:w-1/2">
                            <div className="py-17.5 px-26 text-center">
                                <div>
                                 
                                    <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                                    File <span style={{ color: 'rgb(60, 80, 224)' }}>S</span>haring
                                </h2>
                                </div>

                                <p className="2xl:px-20">
                                    Welcome to our amazing and awesome file downloads
                                </p>
                        ...
                        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
                            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
                                <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                                    Sign In to <span style={{ color: 'rgb(60, 80, 224)' }}>File Download</span>
                                </h2>
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="relative">
                                            ...
                                            <div style={{textAlign:'left',display:'none'}} id="loginerror">
                                                <label className="mb-0 block font-medium mt-2 text-danger">Incorrect auth information...</label>
                                            </div>
                                        </div>
                                    </div>
