...
const InvoiceAdd = () => {
  ...
  useEffect(() => {
      setName(name);
      setInvoiceData(moment(invoice_date).format('YYYY-MM-DD'));
      setInvoiceNumber(invoice_number);
      setDueDate(moment(due_date).format('YYYY-MM-DD'));
      setNotes(notes);
      setCompanyName(company_name);
      setCompanyEmail(company_email);
      setCompanyPhone(company_phone);
      ...
      setTaxType(tax_type_id);
      setTaxValue(tax_value);
      setDiscountType(discount_type_id);
      setDiscountValue(discount_value);
      setInvoiceList(items);
      setInvoiceImg(invoice_img)
  }, [])
