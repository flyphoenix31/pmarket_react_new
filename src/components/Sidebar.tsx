...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const [emailsmenu_flag, setEmailMenuFlag] = useState(true);
  const [usersmenu_flag, setUsersMenuFlag] = useState(true);
  const [clientsmenu_flag, setClientsMenuFlag] = useState(true);
  ...
  let hdata = { role: "chat_history_menu", roleid: role_id };
  let sdata = { role: "setting_menu", roleid: role_id };
  let emenu = { role: "emails_menu", roleid: role_id };
  let cmenu = { role: "clients_menu", roleid: role_id };
  let imenu = { role: "invoice_menu", roleid: role_id };
  let qmenu = { role: "quotation_menu", roleid: role_id };
  let jmenu = { role: "jobs_menu", roleid: role_id };
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="/" style={{ marginLeft: '10px', marginTop: '5px' }}>
          {/* <img src={Logo} alt="Logo" /> */}
          <div>
            <span style={{ fontSize: '40px', color: 'rgb(60, 80, 224)', fontWeight: 600, marginRight: '2px' }}>P</span>
            <span style={{ fontSize: '40px', color: '#FFFFFF', fontWeight: 600 }}>market</span>
          </div>
        </a>
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              <li>
                <NavLink
                  to="/member/chats"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('chats') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <MessageSVG />
              ...
              {chatmenu_flag ?
                <li>
                  <NavLink
                    to="/member/chathistory"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('chathistory') &&
                      'bg-graydark dark:bg-meta-4'
                      }`}
                  >
                    <ChartSVG />
              ...
              <li>
                <NavLink
                  to="/member/shares"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('shares') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <SharedSVG />
              ...
              <li>
                <NavLink
                  to="/member/sharehistory"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${pathname.includes('sharehistory') &&
                    'bg-graydark dark:bg-meta-4'
                    }`}
                >
                  <SaveSVG />
